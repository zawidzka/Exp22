...
saveRDS(sce, file = "SCE_BM_LN_TUM_DR.rds")
...
plotDR(sce, dr = "UMAP", color_by = "meta6")


CATALYST::plotDR(sce, dr = "UMAP", color_by = "meta7", facet_by = "condition")
...
plotDR(sce, dr = "UMAP", color_by = "meta6", facet_by = "condition") +  
  geom_density2d(binwidth = 0.0016, colour = "grey")
